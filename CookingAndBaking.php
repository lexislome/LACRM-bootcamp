<html>
    <head>
        <title>cooking and baking</title>
    </head>

    <body>
        <h1><b>Cooking and Baking</b></h1>
            <h2>Which is better?</h2>
                <p>Most of the time I hear people describe themselves as someone who likes to cook OR someone who likes to bake, not both. Baking is strict, requiring precise measurements and few deviations from the recipe. It's essentially a perfectionist's game. Cooking is more freeform. You can do whatever you want to, so long as it tastes good. Usually these differences cause people to choose one camp over the other, but I like to straddle the border. I prefer the flexibility of cooking over the rigid confines of baking. However, the outcome of baking is more satisfying to me. I love how decorative you can be, and I love the aesthetic of baking. Besides, there's nothing like pulling a sweet treat out of the oven.</p>
            <h2>Cooking</h2>
            ...
            <h2>Baking</h2>
                    ...
                    <ul>
                        ...
                        <li><a href="http://sallysbakingaddiction.com/2014/05/09/peanut-butter-stuffed-brownies/">peanut butter brownies</a></li>
